...
function MyApp({ Component, pageProps }) {
  const acces_data = [
    ...
    { path: "/app/exchange", roles: ["ADMIN", "AVOCAT"] },
    ...
    { path: "/app/admin/planning/:permanence_id", roles: ["ADMIN"] },
              ...
              <div className="row align-items-center">
                <div className="col d-flex align-items-center">
                  <a
                    href="#"
                    onClick={handleClick}
                    className="back-arrow bg-white circle shadow border border-gray-200 rounded mb-0"
                  >
                    <svg
                ...
                <div className="col-auto d-flex flex-wrap align-items-center icon-blue-hover ps-0">
                  ...
                  <div className="grid-option">
                    <Link href="/app/admin/barreau" id="notification">
                      <a className="text-dark ms-4 ms-xxl-5 mb-0 notification-icon">
                        <svg
                          id="Capa_1"
                          xmlns="http://www.w3.org/2000/svg"
                          width="28"
                        ...
                        >
                          <path
                            d="M423,219.5V211h16.5c4.142,0,7.5-3.358,7.5-7.5V179h8.5c4.142,0,7.5-3.358,7.5-7.5v-24c0-2.691-1.442-5.177-3.779-6.512
