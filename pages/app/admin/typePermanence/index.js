...
export default function TypePermanence() {
    ...
    <div className="container-fluid px-0">
      <div className="row">
        <div className="border-bottom border-gray-200 border-3 pb-4 pt-3 mb-4 mb-xl-5">
          <p className="nav nav-segment nav-pills mb-7" role="tablist">
            Avant de créer une permanence, vous devez créer une catégorie
          </p>
        </div>
      </div>
    </div>
