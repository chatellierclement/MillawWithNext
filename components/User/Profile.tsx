        ...
        <form className="px-3 form-style-two">
            <div className="row">
                <div className="col-sm-6 mb-md-4 pb-3">
                    ...
                    <input type="text" className="form-control form-control-xl" id="LastName" placeholder="Nom" value={user ? user.lastName : ""}></input>
                </div>
                
                <div className="col-sm-6 mb-md-4 pb-3">
                    <label htmlFor="FirstName" className="form-label form-label-lg">Prénom</label>
                    <input type="text" className="form-control form-control-xl" id="FirstName" placeholder="Prénom" value={user ? user.firstName : ""}></input>
                </div>
            </div>
            <div className="row">
                <div className="col mb-md-4 pb-3">
                    <label htmlFor="Email" className="form-label form-label-lg">Email</label>
                    <input type="text" className="form-control form-control-xl" id="Email" placeholder="Email" value={user ? user.email : ""}></input>
                </div>
            </div>
